...
Only the latest stable release for macOS Apple Silicon or Windows 11 x64 published from the public
...
Include the affected exact version, operating system version and architecture, a minimal
